...
function SectionExpandableCustomObj() {
	var that = this;
	...
	that.init = function() {
		...
		$('.SectionExpandableCustom').each(function() {
			...
			$(this)
				.find(
					'.SectionExpandableCustom_content div, .SectionExpandableCustom_content span'
				)
...
// create object
SilkUI.SectionExpandable = new SectionExpandableCustomObj();
