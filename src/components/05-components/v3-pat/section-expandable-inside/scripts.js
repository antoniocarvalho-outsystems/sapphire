...
function addClassOpenOrClose(id) {
	id.click(function() {
...
function SectionExpandableInsideObj() {
	var that = this;
	...
	that.ajaxRefresh = function() {
		...
		$('.SectionExpandableInside .SectionExpandableInside_header').on(
			'click',
			function() {
				clickEvents(this);
			}
...
// create object
SilkUI.SectionExpandable = new SectionExpandableInsideObj();

// Execute by SilkUI
SilkUI.Execute(
	SilkUI.SectionExpandable.init,
	'Error on SilkUIFramework/Content/SectionExpandable'
);
